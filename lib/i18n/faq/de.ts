...
Dies ist nützlich, wenn dir jemand über die Schulter schaut oder dein Bildschirm für andere sichtbar ist. Auf den ersten Blick sieht es aus, als würdest du ein Dokument bearbeiten, nicht eine verschlüsselte Unterhaltung führen. Drücke erneut fünfmal Shift, um zur normalen Chat-Ansicht zurückzukehren.`,
  ...
  faq_32_title: "Kann ich nullchat zum Startbildschirm hinzufügen?",
  faq_32_body: `Ja. nullchat unterstützt „Zum Startbildschirm hinzufügen" auf iOS und Android. In iOS Safari tippe auf die Teilen-Schaltfläche und wähle „Zum Home-Bildschirm". In Android Chrome tippe auf das Menü und wähle „Zum Startbildschirm hinzufügen" oder „App installieren". Dies erstellt eine eigenständige Verknüpfung, die nullchat ohne Browser-Oberfläche öffnet — keine Adressleiste, keine Tabs. Es sieht aus und fühlt sich an wie eine native App.

Wichtig: nullchat verwendet absichtlich keinen Service Worker und speichert keine Daten offline. Es gibt keinen Offline-Modus. Die Startbildschirm-Verknüpfung öffnet einfach die Live-Seite — nichts wird auf deinem Gerät gespeichert außer der Verknüpfung selbst. Dies ist eine Sicherheitsentscheidung: Das Caching verschlüsselter Chat-Seiten oder Service-Worker-Skripte auf dem Gerät würde forensische Beweise erzeugen, dass nullchat verwendet wurde. Die Verknüpfung hinterlässt keine Spuren außer ihrem eigenen Symbol, das jederzeit gelöscht werden kann.`,
};
