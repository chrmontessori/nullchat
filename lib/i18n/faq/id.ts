...
Ini berguna jika seseorang melihat dari belakang bahu Anda atau jika layar Anda terlihat oleh orang lain. Sekilas, tampak seperti Anda sedang mengedit dokumen, bukan melakukan percakapan terenkripsi. Tekan Shift lima kali lagi untuk kembali ke tampilan obrolan normal.`,
  ...
  faq_32_title: "Bisakah saya menambahkan nullchat ke layar utama?",
  faq_32_body: `Ya. nullchat mendukung Tambahkan ke Layar Utama di iOS maupun Android. Di iOS Safari, ketuk tombol bagikan dan pilih "Add to Home Screen." Di Android Chrome, ketuk menu dan pilih "Add to Home Screen" atau "Install app." Ini membuat pintasan mandiri yang membuka nullchat tanpa elemen browser — tanpa bilah alamat, tanpa tab. Tampilannya terlihat dan terasa seperti aplikasi native.

Penting: nullchat sengaja tidak menggunakan service worker atau meng-cache data apa pun secara offline. Tidak ada mode offline. Pintasan layar utama hanya membuka situs langsung — tidak ada yang tersimpan di perangkat Anda selain pintasan itu sendiri. Ini adalah keputusan keamanan: meng-cache halaman obrolan terenkripsi atau skrip service worker di perangkat akan menciptakan bukti forensik bahwa nullchat pernah digunakan. Pintasan tidak meninggalkan jejak apa pun selain ikonnya sendiri, yang bisa dihapus kapan saja.`,
};
