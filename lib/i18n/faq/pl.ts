...
Jest to przydatne, gdy ktoś patrzy ci przez ramię lub gdy twój ekran jest widoczny dla innych. Na pierwszy rzut oka wygląda to, jakbyś edytował dokument, a nie prowadził zaszyfrowaną rozmowę. Naciśnij Shift pięć razy ponownie, aby wrócić do normalnego widoku czatu.`,
  ...
  faq_32_title: "Czy mogę dodać nullchat do ekranu głównego?",
  faq_32_body: `Tak. nullchat obsługuje dodawanie do ekranu głównego zarówno na iOS, jak i Androidzie. W Safari na iOS dotknij przycisku udostępniania i wybierz „Dodaj do ekranu głównego". W Chrome na Androidzie dotknij menu i wybierz „Dodaj do ekranu głównego" lub „Zainstaluj aplikację". Tworzy to samodzielny skrót, który otwiera nullchat bez elementów przeglądarki — bez paska adresu, bez kart. Wygląda i działa jak natywna aplikacja.

Ważne: nullchat celowo nie używa service workera ani nie cache'uje żadnych danych offline. Nie ma trybu offline. Skrót na ekranie głównym po prostu otwiera stronę na żywo — na twoim urządzeniu nie jest przechowywane nic poza samym skrótem. To decyzja bezpieczeństwa: cache'owanie zaszyfrowanych stron czatu lub skryptów service worker na urządzeniu stworzyłoby dowody kryminalistyczne, że nullchat był używany. Skrót nie zostawia żadnego śladu poza własną ikoną, którą można usunąć w dowolnym momencie.`,
};
