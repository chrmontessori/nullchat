...
Birisi omzunuzun üzerinden bakıyorsa veya ekranınız başkalarına görünürse bu kullanışlıdır. İlk bakışta, şifreli bir konuşma yapmak yerine bir belge düzenliyormuşsunuz gibi görünür. Normal sohbet görünümüne dönmek için Shift tuşuna beş kez tekrar basın.`,
  ...
  faq_32_title: "nullchat'i ana ekranıma ekleyebilir miyim?",
  faq_32_body: `Evet. nullchat hem iOS hem de Android'de Ana Ekrana Ekle özelliğini destekler. iOS Safari'de paylaş düğmesine dokunun ve "Ana Ekrana Ekle"yi seçin. Android Chrome'da menüye dokunun ve "Ana Ekrana Ekle" veya "Uygulamayı yükle"yi seçin. Bu, nullchat'i tarayıcı çerçevesi olmadan — adres çubuğu yok, sekme yok — açan bağımsız bir kısayol oluşturur. Yerel bir uygulama gibi görünür ve hissedilir.

Önemli: nullchat bilinçli olarak bir service worker kullanmaz veya çevrimdışı herhangi bir veri önbelleğe almaz. Çevrimdışı mod yoktur. Ana ekran kısayolu yalnızca canlı siteyi açar — cihazınızda kısayolun kendisinden başka hiçbir şey saklanmaz. Bu bir güvenlik kararıdır: cihazda şifreli sohbet sayfalarını veya service worker betiklerini önbelleğe almak, nullchat'in kullanıldığına dair adli kanıt oluşturur. Kısayol, herhangi bir zamanda silinebilecek kendi simgesinin ötesinde hiçbir iz bırakmaz.`,
};
